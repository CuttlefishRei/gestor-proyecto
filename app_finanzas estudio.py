...
# ==========================================
# CONFIGURACIÓN DEL ESTILO (La ropa y el look)
# ==========================================
# Aquí le decimos a la aplicación que use un tema oscuro y moderno, 
# como cuando pones tu videojuego o teléfono en "modo noche".
ctk.set_appearance_mode("Dark")
ctk.set_default_color_theme("blue")

# ==========================================
# LA "MOCHILA" DE DATOS (Usuarios registrados)
# ==========================================
# Esta es una lista pequeña donde guardamos quiénes tienen permiso de entrar.
# Es como la lista de invitados en la puerta de una fiesta.
USUARIOS_REGISTRADOS = {"admin": "1234"}

# Esta caja fuerte (diccionario) guarda los historiales de cada amigo por separado.
# Para que lo que gasta Juan no se mezcle con lo que gasta María.
HISTORIALES_USUARIOS = {}

# ==========================================
# CLASE 1: LA VENTANA DEL PORTERO (Login)
# ==========================================
class VentanaLogin(ctk.CTk):
    ...
    def limpiar_ventana(self):
        # Borra todo lo que hay en la pantalla para cambiar de dibujo/pestaña
    ...
    def crear_interfaz_login(self):
        ...
        # Una cajita bonita en el centro de la pantalla donde van los botones
        ...
        # Botón mágico para entrar usando la huella o la cara (Windows Hello)
        ...
        # Espacios para escribir tu nombre de usuario y contraseña secreta
        ...
        # Cartelito por si escribes mal la contraseña (aparece en rojo)
        self.lbl_error = ctk.CTkLabel(card, text="", font=("Segoe UI", 11), text_color="#ff5e62")
        self.lbl_error.grid(row=6, column=0, pady=2)

        # Botón para entrar con usuario y contraseña de toda la vida
        ...
        # Botón para registrar a un nuevo usuario si no tiene cuenta
    ...
    def intentar_biometrico(self):
        # Si la computadora reconoce tu cara/huella, te deja pasar
    ...
    def intentar_login_clasico(self):
        # Revisa si lo que escribiste coincide con nuestra lista de invitados
    ...
    def crear_interfaz_registro(self):
        # Pantalla para crear un usuario nuevo y guardarlo en la lista
        self.limpiar_ventana()
    ...
    def guardar_nuevo_usuario(self):
        ...
        # Guardamos al nuevo usuario en nuestra lista
        USUARIOS_REGISTRADOS[user] = pwd
        self.crear_interfaz_login()

    def abrir_dashboard(self):
        # Cerramos la ventana del login y abrimos la ventana principal del dinero
        self.destroy()
...
# ==========================================
# CLASE 2: EL TABLERO PRINCIPAL (DASHBOARD)
# ==========================================
class DashboardFinanciero(ctk.CTk):
    def __init__(self, usuario):
        ...
        # Las monedas y alcancías empiezan en cero cada vez que entramos
        self.total_ganancias = 0.0
        self.total_gastos = 0.0
        self.total_deudas = 0.0

        # Buscamos en nuestra libreta mágica el historial viejo de este usuario, si no tiene, le damos una hoja en blanco
    ...
    def construir_dashboard(self):
        # Cabecera de la app: Saluda al usuario y muestra el botón para salir
        ...
        # Botón para cerrar sesión (como apagar la tele y regresar al menú principal)
        ...
        # Botones grandes para agregar dinero, gastarlo o anotar deudas
        ...
        # Tarjeta del centro que dibuja la rosquilla/gráfica de salud financiera
        ...
        # El lienzo donde pintamos las barritas circulares con matemáticas
        ...
        # Textos chiquitos que muestran los totales abajo de la gráfica
        ...
        # Sección inferior: El historial con la lista de todo lo que hemos comprado o ganado
    ...
    def cerrar_sesion(self):
        # Te saca del tablero y te regresa a la ventana de poner contraseña
        self.destroy()
        app = VentanaLogin()
        app.mainloop()

    def dibujar_grafico(self, g, gs, d):
        # Esta función calcula los ángulos geométricos como si fuera un pay de queso 
        # para rellenar la gráfica en forma de rosquilla según tus gastos o ganancias.
    ...
    def abrir_ventana_transaccion(self, tipo):
        # Ventana flotante chiquita para escribir cuánto dinero vas a mover
        ...
        # Opciones desplegables para elegir de qué es el movimiento (comida, salario, etc.)
        categorias_opciones = {
        ...
        def guardar():
            try:
                ...
                # Sumamos o restamos a la alcancía principal según lo que elegiste
                if tipo == "Ingreso":
                ...
                # Guardamos el movimiento en el historial personal de este usuario
    ...
    def actualizar_dashboard_ui(self):
        # Refresca los números en la pantalla para que veas tus cuentas al día
    ...
    def actualizar_historial_ui(self):
        # Limpia la lista vieja en pantalla y dibuja renglón por renglón los nuevos movimientos
